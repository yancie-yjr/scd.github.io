<html>
   ...
   <body>
      ...
      <div id="_html" class="markdown-body">
         ...
         <div align="center">
            <h1 id="rpc-a-large-scale-retail-product-checkout-dataset">RPC: A Large-Scale Retail Product Checkout Dataset</h1>
            <p><strong><a href="http://www.weixiushen.com/">Xiu-Shen Wei<sup>1*</sup></a> &nbsp;&nbsp;&nbsp; Quan Cui<sup>1,2</sup> &nbsp;&nbsp;&nbsp; <a href="https://github.com/DIYer22">Lei Yang<sup>1</sup></a>&nbsp;&nbsp;&nbsp; Peng Wang<sup>3</sup> &nbsp;&nbsp;&nbsp; Lingqiao Liu<sup>3</sup></strong></p>
